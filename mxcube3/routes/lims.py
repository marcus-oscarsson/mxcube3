...
def get_results():
    ...
    if qid:
        ...
        elif isinstance(model, qmo.Characterisation):
            if result_file_test('characterisation-results.js'):
                url = 'https://ispyb.esrf.fr/ispyb/ispyb-ws/rest/e0896c80777d322df617e2190f60f20a643eebb5/proposal/MX415/mx/workflow/step/344316/result'
                r = jsonify({"result": run_get_result_script(join(mxcube.template_folder, 'characterisation-results.js'), url)})
